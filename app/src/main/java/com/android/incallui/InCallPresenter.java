...
public class InCallPresenter implements CallList.Listener {
   ...
   * 这里有新的电话过来或者电话状态改变这里是最开始调用的地方
   */
  private InCallState startOrFinishUi(InCallState newState) {
    LogUtil.d("InCallPresenter.startOrFinishUi", "startOrFinishUi: " + mInCallState + " -> " + newState);
    ...
    if (showCallUi || showAccountPicker) {
      ...
      Intent intent =
              InCallActivity.getIntent(
                      mContext, false /* showDialpad */, false /* newOutgoingCall */, true);
